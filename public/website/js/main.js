...
// ================================================================
// GLOWING BORDER EFFECT — mouse-tracking glow on .glow-card elements
// Vanilla JS port of React GlowingEffect component
// ================================================================
(function initGlowEffect() {
    ...
    window.addEventListener('scroll', () => {
        handlePointerMove({ clientX: -9999, clientY: -9999 });
    }, { passive: true });
}());
